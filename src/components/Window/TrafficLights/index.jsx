  ...
  return (
    ...
    >
      <div className={s.red} onClick={() => router.push('/')}>
        {hovering && (
          <Image src={redS} width={7.5} height={7.5} alt="close button" />
        )}
      </div>
      <div className={s.yellow} onClick={onMinimize}>
        {hovering && (
          <Image src={yellowS} width={9.5} height={3} alt="minimize button" />
        )}
      </div>
      <div className={s.green} onClick={onMaximize}>
        {hovering && (
          <Image src={greenS} width={6} height={6} alt="maximize button" />
        )}
      </div>
    </div>
  );
