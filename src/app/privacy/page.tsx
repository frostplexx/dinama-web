...
export default function PrivacyPage() {
    return (
        <Window title="Privacy Policy" label="">
            <div>
                <h1>Privacy Policy for Daniel Inama</h1>

                <p>
                    At dinama.dev, accessible from dinama.dev, one of our main priorities is the
                    privacy of our visitors. This Privacy Policy document contains types of
                    information that is collected and recorded by dinama.dev and how we use it.
                </p>
                ...
                <p>
                    ...
                    collect in dinama.dev. This policy is not applicable to any information
                ...
                <p>
                    dinama.dev follows a standard procedure of using log files. These files log
                ...
                <p>
                    Like any other website, dinama.dev uses "cookies". These cookies are used to
                ...
                <p>
                    ...
                    partners of dinama.dev.
                </p>

                <p>
                    Third-party ad servers or ad networks uses technologies like cookies,
                    JavaScript, or Web Beacons that are used in their respective advertisements and
                    links that appear on dinama.dev, which are sent directly to users' browser. They
                ...
                <p>
                    Note that dinama.dev has no access to or control over these cookies that are
                ...
                <p>
                    dinama.dev's Privacy Policy does not apply to other advertisers or websites.
                ...
                <p>
                    dinama.dev does not knowingly collect any Personal Identifiable Information from
